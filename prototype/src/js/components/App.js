...
export default class App extends Component {
	...
	componentDidMount() {
		const { externalStylesheet } = this.props.theme;
		(externalStylesheet) ? (
			fetch(externalStylesheet)
			.then(response => {
	...
	getGlobalStyle() {
		...
		str += ".theme-background { background-color: " + colorHighlight +  ";}";
		str += ".rc-slider-track { background-color: " + colorHighlight +  ";}";
		str += this.state.externalStylesheet;
